...
typedef enum{
	...
	Internal = 0x60// Internal 2.56V Voltage Reference with external capacitor at AREF pin
	}ADC_ReferenceVolatge;

typedef enum {
	F_CPU_2   = 0x01 , // F_CPU/2
	F_CPU_4   = 0x02 , // F_CPU/4
	F_CPU_8   = 0x03 , // F_CPU/8
	F_CPU_16  = 0X04 , // F_CPU/16
	F_CPU_32  = 0x05 , // F_CPU_32
	F_CPU_64  = 0x06 , // F_CPU_64
	F_CPU_128 = 0x07
	}ADC_Prescaler;
